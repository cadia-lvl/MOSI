...
from mosi.db import get_verifiers, activity, insert_trims, resolve_order
from mosi.forms import DailySpinForm, SessionVerifyForm, DeleteVerificationForm
from mosi.models import PrioritySession, Verification, Session, User, Recording, db, Collection
    ...
    try:
        if form.validate():
            ...
            if is_secondary and num_recordings == recordings.filter(
                ...
                db.session.commit()
            if num_recordings == recordings.filter(
